    ...
    gerar: {
      jobs: function(){
          ...
          $.getJSON('./data.json', function(json) {
              ...
              json.sort((a,b)=> {return new Date(a.diarias[(a.diarias.length-1)].inicio)-new Date(b.diarias[(b.diarias.length-1)].inicio);}).forEach((a,b,c) => {
                ...
                let el = `<div class="item">
                          ...
                          <div style="margin-left: 10px;" onclick="editorMinuta.abrir(`+b+`,'abrir');">
                            <h4>`+a.job+`</h4>
